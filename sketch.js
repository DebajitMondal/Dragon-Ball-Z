...
function draw() {  
  ...
  if (GameState === 0){
    ...
    text("To start the game press e, to throw power ball press q , to jump press space",windowWidth/3,windowHeight/5.5)
    text("To go Right press Right Arrow, and to go Left press Left Arrow",windowWidth/3,windowHeight/4.7)
    text("To Throw Energy Ball reach take 10 Dragon ball",windowWidth/3,windowHeight/4)
    text("You have only 3 lives",windowWidth/3,windowHeight/3.5)
    textSize(30)
    text("Welcome to ",windowWidth/3,windowHeight/3)
